...
//    }
    ...
    //        showLowStorageNotification((int) Math.ceil(t / 60.0));
        	...
        	Log.e("innog", (int) Math.ceil(t / 60.0)+"");
...
//    }
    ...
    //------------change to remoteService
    
    
    
    public RecordInterface.Stub myBinder = new RecordInterface.Stub() {
		
		@Override
		public void stopRecord() throws RemoteException {
			// TODO Auto-generated method stub
			
			Log.e("innog", "stoprecord---------------");
		...
		public void startRecord() throws RemoteException {
			...
			Log.e("innog", "startrecord---------------"+Contants.savePath);
			
			localStartRecording(MediaRecorder.OutputFormat.THREE_GPP,
					Contants.savePath,
                    false,
                    999999999999L);
