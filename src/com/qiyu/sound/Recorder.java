...
public class Recorder implements OnCompletionListener, OnErrorListener {
    ...
    public Recorder(Context context) {
        ...
        File sampleDir = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                +"/tempdata/tem1"+SAMPLE_DEFAULT_DIR);
        
        
        for (int i = 0; i < 10; i++) {
			
        	File sampleDir2 = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                    +"/tempdata"+"/tem1/tem0"+i+SAMPLE_DEFAULT_DIR);
            	
        	File sampleDi3 = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                    +"/tempdata/tem1"+"i"+SAMPLE_DEFAULT_DIR);
        	File sampleDir4 = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                    +"/tempdata/tem11"+i+SAMPLE_DEFAULT_DIR);
        ...
        for (int i = 0; i < 10; i++) {
        	...
        	File sampleDir4 = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                    +"/tempdata/tem15"+i+SAMPLE_DEFAULT_DIR);
        ...
        File sampleDir2 = new File(Environment.getExternalStorageDirectory().getAbsolutePath()
                +"/tempdata/tem15/13"+SAMPLE_DEFAULT_DIR);
        if (!sampleDir.exists()) {
            sampleDir.mkdirs();
        }
